...
public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(List.of( "http://localhost:5173", "http://localhost:5174","http://localhost:4200","https://historia-clinica-front-ggzr.vercel.app/","http://192.168.0.3"));
