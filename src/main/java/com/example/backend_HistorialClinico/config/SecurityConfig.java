...
public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(List.of( "http://localhost:5173", "http://localhost:5174","http://localhost:4200","historia-clinica-front-cyjf.vercel.app","http://192.168.0.3","http://localhost:8080"));
